...
.factory('FeedFct', ['$http', function($http) {
    return {
      pendingChallenge: function(userId) {
        return $http.get('http://www.bestridaapp.com/api/challenges/pending/'+ userId);
      },
      getFriends: function(userId) {
        return $http.get('http://www.bestridaapp.com/api/friends/' + userId);
      },
      postAcceptChallenge: function(challenge) {
        return $http.post('http://www.bestridaapp.com/api/challenges/accept', challenge);
      },
      postDeclineChallenge: function(challenge) {
        return $http.post('http://www.bestridaapp.com/api/challenges/decline', challenge);
      }
    };
}])
...
.factory('CreateFct', ['$http', function($http) {
  return {
    createChallenge: function(data) {
      return $http.post('http://www.bestridaapp.com/api/challenges/create', data);
    },
    getUser: function(challengerId) {
      return $http.get('http://www.bestridaapp.com/api/users/' + challengerId);
    },
    getSegments: function() {
      return $http.get('http://www.bestridaapp.com/api/segments/');
    }
  };
}])

.factory('AuthFct', function ($window, $state, localStorageService, $location) {
  var url = 'http://www.bestridaapp.com/auth/strava';
  var loginWindow, token, hasToken, userId, hasUserId;
  return {
  login : function () {
    loginWindow = $window.open(url, '_blank', 'location=no,toolbar=no');
    loginWindow.addEventListener('loadstart', function (event) {
      if((event.url).startsWith("http://www.bestridaapp.com/loggedIn.html")) {
...
.factory('CompletedFct', ['$http', function($http) {
  return {
    ...
    getCompletedChallenge: function(userId) {
      return $http.get('http://www.bestridaapp.com/api/challenges/completed/' + userId);
    }
  };
}])
...
.factory('ActiveChallengesFct', ['$http', function($http) {
  return {
    getActiveChallenges: function(userId) {
      return $http.get('http://www.bestridaapp.com/api/challenges/active/' + userId);
    },
    getFriends: function(userId) {
      return $http.get('http://www.bestridaapp.com/api/friends/' + userId);
    },
    removeActiveChallenge: function(activeChallenge, userId) {
      ...
      return $http.post('http://www.bestridaapp.com/api/challenges/complete', completeChallenge);
    }
  };
}])
...
.factory('ChallengeStatsFct', ['$http', function($http) {
  return {
    getChallenge: function(challengerId) {
      return $http.get('http://www.bestridaapp.com/api/challenges/' + challengerId);
    }
  };
}])
...
.factory('PendingDetailFct', ['$http', function($http) {
  return {
    getSegment: function(segmentId) {
      return $http.get('http://www.bestridaapp.com/api/segments/' + segmentId);
    }
  };
}]);
